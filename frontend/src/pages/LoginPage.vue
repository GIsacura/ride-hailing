<template>
  <q-page class="flex flex-center column">
    ...
    <q-form @submit="onSubmit" class="form">
      ...
      <q-btn class="input" type="submit" label="Iniciar sesión" color="primary" />
    </q-form>

    <p>¿No tienes cuenta?. <span class="register-link" @click="router.push('/register')">Regístrate</span></p>
  </q-page>
</template>
